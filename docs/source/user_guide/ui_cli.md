...
* The container installation process has been completed
  * If not, navigate [here](..\installation-guide.md)
...
* `-n, --name`: name of the model Compilation: desired name for the generated model (should be identical to model's folder name).Simulation: name of the input model.
* `-m, --model`: relative path to the direcotyr containing the models folders
* `-v, --verbose`: enable verbose output.
* `-y, --yaml`: YAML file with input configuration
* `-i, --input`: name of the subfolder containing SPARCED formatted input files
* 
