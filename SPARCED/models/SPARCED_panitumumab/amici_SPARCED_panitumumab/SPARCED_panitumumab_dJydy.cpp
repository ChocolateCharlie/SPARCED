...
void dJydy_SPARCED_panitumumab(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            dJydy[0] = (-1.0*mypanit_EC + 1.0*ypanit_EC)/std::pow(sigma_ypanit_EC, 2);
            break;
        case 774:
            dJydy[0] = (-1.0*mypanit_E1_EC + 1.0*ypanit_E1_EC)/std::pow(sigma_ypanit_E1_EC, 2);
            break;
        case 775:
