...
/*-----------------------------------------------
              @(target):= _SPARCED_panitumumab.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__SPARCED_panitumumab

#else
#  define SWIG_init    init_SPARCED_panitumumab

#endif
#define SWIG_name    "_SPARCED_panitumumab"
