"""AMICI-generated module for model SPARCED_panitumumab"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.12' != amici.__version__:
    raise RuntimeError('Cannot use model SPARCED_panitumumab, generated with AMICI '
...
from SPARCED_panitumumab._SPARCED_panitumumab import *
