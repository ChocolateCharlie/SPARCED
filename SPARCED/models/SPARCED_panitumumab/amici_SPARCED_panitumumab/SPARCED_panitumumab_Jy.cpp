...
void Jy_SPARCED_panitumumab(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ypanit_EC, 2)) + 0.5*std::pow(-mypanit_EC + ypanit_EC, 2)/std::pow(sigma_ypanit_EC, 2);
            break;
        case 774:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ypanit_E1_EC, 2)) + 0.5*std::pow(-mypanit_E1_EC + ypanit_E1_EC, 2)/std::pow(sigma_ypanit_E1_EC, 2);
            break;
        case 775:
