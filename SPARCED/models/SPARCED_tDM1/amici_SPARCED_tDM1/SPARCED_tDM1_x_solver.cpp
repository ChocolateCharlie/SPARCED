...
void x_solver_SPARCED_tDM1(realtype *x_solver, const realtype *x_rdata){
    x_solver[0] = Ribosome;
    x_solver[1] = p53inac;
    x_solver[2] = p53ac;
    x_solver[3] = MDM2;
    ...
    x_solver[773] = trast_DM1_EC;
    x_solver[774] = trast_EC;
    x_solver[775] = DM1_EC;
    x_solver[776] = E2_EC;
    x_solver[777] = trast_DM1_E2_EC;
    x_solver[778] = trast_E2_EC;
    x_solver[779] = E2_endo;
    x_solver[780] = trast_DM1_E2_endo;
    x_solver[781] = trast_E2_endo;
    x_solver[782] = DM1_endo;
    x_solver[783] = DM1_IC;
    x_solver[784] = target;
    x_solver[785] = DM1_target;
}
