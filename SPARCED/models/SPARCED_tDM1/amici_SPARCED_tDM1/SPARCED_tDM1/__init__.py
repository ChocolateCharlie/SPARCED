"""AMICI-generated module for model SPARCED_tDM1"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.12' != amici.__version__:
    raise RuntimeError('Cannot use model SPARCED_tDM1, generated with AMICI '
...
from SPARCED_tDM1._SPARCED_tDM1 import *
