...
void dJydy_SPARCED_tDM1(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            dJydy[0] = (-1.0*mytrast_DM1_EC + 1.0*ytrast_DM1_EC)/std::pow(sigma_ytrast_DM1_EC, 2);
            break;
        case 774:
            dJydy[0] = (-1.0*mytrast_EC + 1.0*ytrast_EC)/std::pow(sigma_ytrast_EC, 2);
            break;
        case 775:
            dJydy[0] = (-1.0*myDM1_EC + 1.0*yDM1_EC)/std::pow(sigma_yDM1_EC, 2);
            break;
        case 776:
            dJydy[0] = (-1.0*myE2_EC + 1.0*yE2_EC)/std::pow(sigma_yE2_EC, 2);
            break;
        case 777:
            dJydy[0] = (-1.0*mytrast_DM1_E2_EC + 1.0*ytrast_DM1_E2_EC)/std::pow(sigma_ytrast_DM1_E2_EC, 2);
            break;
        case 778:
            dJydy[0] = (-1.0*mytrast_E2_EC + 1.0*ytrast_E2_EC)/std::pow(sigma_ytrast_E2_EC, 2);
            break;
        case 779:
            dJydy[0] = (-1.0*myE2_endo + 1.0*yE2_endo)/std::pow(sigma_yE2_endo, 2);
            break;
        case 780:
            dJydy[0] = (-1.0*mytrast_DM1_E2_endo + 1.0*ytrast_DM1_E2_endo)/std::pow(sigma_ytrast_DM1_E2_endo, 2);
            break;
        case 781:
            dJydy[0] = (-1.0*mytrast_E2_endo + 1.0*ytrast_E2_endo)/std::pow(sigma_ytrast_E2_endo, 2);
            break;
        case 782:
            dJydy[0] = (-1.0*myDM1_endo + 1.0*yDM1_endo)/std::pow(sigma_yDM1_endo, 2);
            break;
        case 783:
            dJydy[0] = (-1.0*myDM1_IC + 1.0*yDM1_IC)/std::pow(sigma_yDM1_IC, 2);
            break;
        case 784:
            dJydy[0] = (-1.0*mytarget + 1.0*ytarget)/std::pow(sigma_ytarget, 2);
            break;
        case 785:
            dJydy[0] = (-1.0*myDM1_target + 1.0*yDM1_target)/std::pow(sigma_yDM1_target, 2);
            break;
        case 786:
