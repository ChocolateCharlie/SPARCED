...
void Jy_SPARCED_tDM1(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytrast_DM1_EC, 2)) + 0.5*std::pow(-mytrast_DM1_EC + ytrast_DM1_EC, 2)/std::pow(sigma_ytrast_DM1_EC, 2);
            break;
        case 774:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytrast_EC, 2)) + 0.5*std::pow(-mytrast_EC + ytrast_EC, 2)/std::pow(sigma_ytrast_EC, 2);
            break;
        case 775:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yDM1_EC, 2)) + 0.5*std::pow(-myDM1_EC + yDM1_EC, 2)/std::pow(sigma_yDM1_EC, 2);
            break;
        case 776:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yE2_EC, 2)) + 0.5*std::pow(-myE2_EC + yE2_EC, 2)/std::pow(sigma_yE2_EC, 2);
            break;
        case 777:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytrast_DM1_E2_EC, 2)) + 0.5*std::pow(-mytrast_DM1_E2_EC + ytrast_DM1_E2_EC, 2)/std::pow(sigma_ytrast_DM1_E2_EC, 2);
            break;
        case 778:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytrast_E2_EC, 2)) + 0.5*std::pow(-mytrast_E2_EC + ytrast_E2_EC, 2)/std::pow(sigma_ytrast_E2_EC, 2);
            break;
        case 779:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yE2_endo, 2)) + 0.5*std::pow(-myE2_endo + yE2_endo, 2)/std::pow(sigma_yE2_endo, 2);
            break;
        case 780:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytrast_DM1_E2_endo, 2)) + 0.5*std::pow(-mytrast_DM1_E2_endo + ytrast_DM1_E2_endo, 2)/std::pow(sigma_ytrast_DM1_E2_endo, 2);
            break;
        case 781:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytrast_E2_endo, 2)) + 0.5*std::pow(-mytrast_E2_endo + ytrast_E2_endo, 2)/std::pow(sigma_ytrast_E2_endo, 2);
            break;
        case 782:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yDM1_endo, 2)) + 0.5*std::pow(-myDM1_endo + yDM1_endo, 2)/std::pow(sigma_yDM1_endo, 2);
            break;
        case 783:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yDM1_IC, 2)) + 0.5*std::pow(-myDM1_IC + yDM1_IC, 2)/std::pow(sigma_yDM1_IC, 2);
            break;
        case 784:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ytarget, 2)) + 0.5*std::pow(-mytarget + ytarget, 2)/std::pow(sigma_ytarget, 2);
            break;
        case 785:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yDM1_target, 2)) + 0.5*std::pow(-myDM1_target + yDM1_target, 2)/std::pow(sigma_yDM1_target, 2);
            break;
        case 786:
